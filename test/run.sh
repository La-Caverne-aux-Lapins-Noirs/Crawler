...
libs="-L${HOME}/.froot/lib/ -I${HOME}/.froot/include/ -L../ -I../include/ --whole-file -lcccrawler -llapin -lavcall -lopencv_imgproc -lopencv_highgui -lopencv_objdetect -lopencv_video -lopencv_core -ldl -lm -lusb -lgcov -lstdc++"
